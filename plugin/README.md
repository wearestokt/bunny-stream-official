...
Framer plugin that provides a component palette for Bunny Stream video player. Drag components from the plugin window onto your canvas.
...
BunnyVideoStore (shared state) is created automatically when needed.
